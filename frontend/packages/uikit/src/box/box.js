...
// @TODO fix this with ng-cloumns values
...
const Box = props => {
  ...
  const inlineStyles = {
    marginTop: get(sizesValue, top),
    marginBottom: get(sizesValue, bottom),
    marginLeft: get(sizesValue, left),
    marginRight: get(sizesValue, right),
